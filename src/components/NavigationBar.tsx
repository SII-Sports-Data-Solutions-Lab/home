  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4 md:px-6">
        ...
        >
          <span className="text-2xl font-playfair font-bold">IU</span>
          <span className="text-lg hidden sm:inline font-medium">Review Analysis Project</span>
        </Link>
        ...
        <nav>
          ...
          <div className="md:hidden">
            <button className="p-2 text-gray-700 hover:text-indiana-crimson">
              <svg 
